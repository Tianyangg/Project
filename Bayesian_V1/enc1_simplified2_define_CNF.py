from Bayesian_V1 import enc1_simplified_2 as df_v
        ...
        for j in range(0, node_cardinality):
            ...
            if not triple_list:     # Case1: without evidence
                ...
                if df_v.parameter_weights[temp_name] != 0 and df_v.parameter_weights[temp_name] != 1:
                    ...
                    cnf_clause = [(-1, df_v.variable_dictionary[temp_name]), (1, df_v.variable_dictionary['lambda_' + i + str(j)])]
                    parameter_clauses.append(cnf_clause)
                #simplification
                ...
                for x in triple_list:
                    ...
                    if df_v.parameter_weights[temp_name] != 0 and df_v.parameter_weights[temp_name] != 1:
                        ...
                        # PI clauses
                        for k in pi_temp:
                            cnf_clause = [(-1, df_v.variable_dictionary[temp_name]), (1, k)]
                            parameter_clauses.append(cnf_clause)
